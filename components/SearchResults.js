...
function SearchResults({results}) {
    return <div className="mx-auto w-full px-3 sm:pl-[5%] md:pl-[14%] lg:pl-52">
                <p className="text-gray-600 text-md mb-5 mt-3">{results && "Khoảng"}   {results?.searchInformation?.formattedTotalResults} {!results && "0"} kết quả ({results?.searchInformation?.formattedSearchTime} {!results && "0"}  giây)</p>
